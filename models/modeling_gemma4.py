...
from logattention import gemma4_attn_forward
...
class Gemma4TextAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.layer_type == "full_attention": # full_attention layers are replaced by RBA
            return gemma4_attn_forward(self,
                                                hidden_states,
                                                position_embeddings,
                                                attention_mask,
                                                shared_kv_states,
